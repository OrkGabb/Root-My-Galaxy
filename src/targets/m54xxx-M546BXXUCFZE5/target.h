...
/*
 * SM-M546B / M546BXXUCFZE5 (Galaxy M54 5G, Exynos 1380)
 * Kernel: 5.15.189-android13-3-33470412
 * Build:  BP4A.251205.006.M546BXXUCFZE5
 * Region: ZTO
 *
 * All offsets recovered from the exact Image + BTF of this build.
 * DO NOT reuse on any other firmware.
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "m54xxx-M546BXXUCFZE5-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "m54xxx-M546BXXUCFZE5-root-umh"
#endif
...
#define P0_PHYS_OFFSET 0x10000000ULL
#define P0_KERNEL_PHYS_LOAD 0x10008000ULL
#define SKB_DATA_DELTA (-0xe80LL)

/* 5.15 layouts — NOT legacy 5.10 */
...
/* --- Symbol offsets (relative to KIMAGE_TEXT_BASE) --- */
...
/* rt_mutex_waiter — 5.15 post-rework, sizeof=0x58 */
...
/* task_struct — from BTF of this exact build */
...
/* file_operations — sizeof=0x120 from BTF */
